...
export default defineConfig({
  resolve: {
    alias: [
      ...
      {
        find: 'core/guarantee-state',
        replacement: resolve(root, 'packages/core/guarantee-state.ts'),
      },
      {
        find: 'core/clawback-ledger',
        replacement: resolve(root, 'packages/core/clawback-ledger.ts'),
      },
      ...
      {
        find: 'db/clawback',
        replacement: resolve(root, 'packages/db/src/clawback.ts'),
      },
