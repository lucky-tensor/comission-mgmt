 ...
 *
 * Commission entity SENSITIVE_FIELDS covers: placement, contributor, commission, invoice.
...
export const SENSITIVE_FIELDS: Partial<Record<EntityType, string[]>> = {
  ...
  placement: ['candidate_name', 'candidate_email', 'salary', 'fee_amount'],
  contributor: ['full_name', 'email', 'bank_account', 'tax_id'],
  commission: ['amount', 'notes'],
  invoice: ['billing_name', 'billing_email', 'amount'],
};
